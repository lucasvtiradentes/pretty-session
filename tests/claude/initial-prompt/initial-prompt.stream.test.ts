...
import { replayClaudeStreamWithSession } from '../../initial-prompt-helpers'
...
describe('initial prompt - stream mode', () => {
	it('renders the initial user prompt from stream fixture', () => {
		const output = replayClaudeStreamWithSession(stream, session)
